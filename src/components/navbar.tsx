    ...
    return (
        <header>
            <div className="fixed z-10 flex w-full justify-center ">
                <nav
                    id="global-navbar"
                    className="mt-8 flex w-fit max-w-5xl justify-center gap-8 rounded-full bg-myTheme-background/50 p-8 py-2 text-sm outline outline-1 outline-myTheme-primary backdrop-blur sm:text-base"
                >
